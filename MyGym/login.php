...
<body>
	...
	<div class="main_wrapper">
		...
		<!-- footer Start -->
		<div class="footer">
			<h5 style="color:#000; padding-top:30px; text-align:center; font-family: Verdana, Geneva, sans-serif">&copy; 2018 all rights reserved | Developed By:'SVPM' TE comp</h5>
		</div>
		<!-- Footer End -->
